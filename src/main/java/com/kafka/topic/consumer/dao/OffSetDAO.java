...
public class OffSetDAO {
    ...
    private static final String POPULATE_DEFAULT_OFFSET_SQL = "insert into partition_offsets values(?, ? , ?)";
    ...
    private static final String POPULATE_REQUEST_SQL = "insert into transaction_data values(?,?)";
